...
```bash
cd backend
cp ../.env.example ../.env   # o exporta las variables manualmente, ver abajo
export JWT_SECRET="MesaSitec-2026-Clave-Secreta-Super-Larga-Para-JWT-HS256-Desarrollo"
dotnet run --project src/Api
```

La API queda disponible en `http://localhost:5080`. Al arrancar, aplica las migraciones y siembra los datos automáticamente si la base está vacía (archivo `mesasitec.db`, se crea solo).
